...
public class MainJOP {
    ...
    public static void main(String[] args){
        ...
        String aumentoMje = JOptionPane.showInputDialog("ingrese el porcentaje del aumento(si es el 15% ingresar 0.15): ");
        float salarioSinAjuste = Float.parseFloat(salarioSinAjusteMje);
        float aumento = Float.parseFloat(aumentoMje);
        EjercicioIF pruebaJOP = new EjercicioIF(salarioSinAjuste, aumento, 0);
